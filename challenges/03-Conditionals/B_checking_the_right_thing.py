...
if alice_is_drinking: # Again - I'm play it safe and checking everyone, fix this!
...
if bob_is_drinking: # Again - I'm play it safe and checking everyone, fix this!
    print "Checking Bob"
...
if charles_is_drinking: # Again - I'm play it safe and checking everyone, fix this!
